            ...
            <div style="height: 30vh;" class="modal-body pb-16 p-5 overflow-y-auto">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div class="mb-4">
                  ...
                  <input v-model="category.name" @input="updateSlug" class="border rounded-md py-2 px-3 w-full"
                    type="text" id="name" name="name" placeholder="Nom de la catégorie" required />
                </div>
                <div class="mb-4">
                  <label class="block text-gray-700 text-sm font-bold mb-2" for="slug">Slug :</label>
                  <input v-model="category.slug" class="border rounded-md py-2 px-3 w-full" type="text" id="slug"
...
const categorySlug = ref(''); // Champ de slug
function updateSlug() {
  console.log('====================================');
  console.log();
  console.log('====================================');
